...
var Message = /*#__PURE__*/_createClass(function Message(payload, target) {
...
function sendMessage(winDom, message) {
...
function listenToMessage(handler) {
  window.addEventListener("message", function (event) {
    handler(event);
  }, false);
}
function stopListenToMessage(handler) {
...
var CandyIframe = /*#__PURE__*/function (_React$Component) {
  _inherits(CandyIframe, _React$Component);

  var _super = _createSuper(CandyIframe);

  function CandyIframe(probs) {
    var _this;

    _classCallCheck(this, CandyIframe);
  ...
  _createClass(CandyIframe, [{
    ...
    value: function componentDidUpdate(prevProps, prevState, snapshot) {
      if (prevProps.payload !== this.props.payload) {
        var msg = new Message(this.props.payload, "http://localhost:3001");
    ...
    value: function render() {
      ...
      var props = Object.assign({}, CandyIframe.initialProbs, this.props.attributes);
...
export { listenToMessage, sendMessage, stopListenToMessage };
